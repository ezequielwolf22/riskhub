...
def _migrate_columns() -> None:
    ...
    migrations = [
        ...
        # Jerarquia real de procesos: proceso padre + unidad de negocio.
        ("ALTER TABLE business_processes ADD COLUMN parent_process_id INTEGER REFERENCES business_processes(id)",
         "business_processes", "parent_process_id"),
        ("ALTER TABLE business_processes ADD COLUMN business_unit VARCHAR(128)",
         "business_processes", "business_unit"),
        ...
        # v6.5.0 — Ingesta cognitiva: atributos de sede que gobiernan la
        # aplicabilidad de escenarios (la regla vive en bcm_applicability_rules,
        # nunca cableada: sin reglas, todo escenario aplica a toda sede).
        ("ALTER TABLE bcm_locations ADD COLUMN city VARCHAR(128)",
         "bcm_locations", "city"),
        ("ALTER TABLE bcm_locations ADD COLUMN site_type VARCHAR(16)",
         "bcm_locations", "site_type"),
        ("ALTER TABLE bcm_locations ADD COLUMN staffing_model VARCHAR(16)",
         "bcm_locations", "staffing_model"),
        ("ALTER TABLE bcm_locations ADD COLUMN business_unit VARCHAR(128)",
         "bcm_locations", "business_unit"),
        # v6.5.0 — Estrategia de continuidad como alternativa a un escenario
        ("ALTER TABLE bcp_strategies ADD COLUMN scenario_id INTEGER REFERENCES bcm_scenarios(id)",
         "bcp_strategies", "scenario_id"),
        ("ALTER TABLE bcp_strategies ADD COLUMN requirements TEXT",
         "bcp_strategies", "requirements"),
        ("ALTER TABLE bcp_strategies ADD COLUMN resources TEXT",
         "bcp_strategies", "resources"),
        # location_id de bcp_strategies ya se migra mas arriba (v3.x); el modelo
        # lo declara ahora, pero no se repite el ALTER: el inspector toma una
        # unica foto del esquema y una entrada duplicada rompe la migracion.
        ("ALTER TABLE bcp_strategies ADD COLUMN source VARCHAR(16)",
         "bcp_strategies", "source"),
        ("ALTER TABLE bcp_strategies ADD COLUMN import_batch_id INTEGER REFERENCES ingest_batches(id)",
         "bcp_strategies", "import_batch_id"),
        # v6.5.0 — Trazabilidad de ingesta en las entidades BCP materializables:
        # de que lote salio cada fila, con que confianza y si pide revision.
        ("ALTER TABLE bcp_plans ADD COLUMN scenario_ids JSON", "bcp_plans", "scenario_ids"),
        ("ALTER TABLE bcp_plans ADD COLUMN source VARCHAR(16)", "bcp_plans", "source"),
        ("ALTER TABLE bcp_plans ADD COLUMN import_batch_id INTEGER REFERENCES ingest_batches(id)",
         "bcp_plans", "import_batch_id"),
        ("ALTER TABLE bcp_plans ADD COLUMN needs_review BOOLEAN DEFAULT 0",
         "bcp_plans", "needs_review"),
        ("ALTER TABLE bcp_plans ADD COLUMN import_confidence REAL",
         "bcp_plans", "import_confidence"),
        ("ALTER TABLE bcp_plans ADD COLUMN source_sha256 VARCHAR(64)",
         "bcp_plans", "source_sha256"),
        ("ALTER TABLE bcp_tests ADD COLUMN scenario_ids JSON", "bcp_tests", "scenario_ids"),
        ("ALTER TABLE bcp_tests ADD COLUMN source VARCHAR(16)", "bcp_tests", "source"),
        ("ALTER TABLE bcp_tests ADD COLUMN import_batch_id INTEGER REFERENCES ingest_batches(id)",
         "bcp_tests", "import_batch_id"),
        ("ALTER TABLE bcp_tests ADD COLUMN needs_review BOOLEAN DEFAULT 0",
         "bcp_tests", "needs_review"),
        ("ALTER TABLE bcp_tests ADD COLUMN import_confidence REAL",
         "bcp_tests", "import_confidence"),
        ("ALTER TABLE bcp_tests ADD COLUMN source_sha256 VARCHAR(64)",
         "bcp_tests", "source_sha256"),
        ("ALTER TABLE business_processes ADD COLUMN source VARCHAR(16)",
         "business_processes", "source"),
        ("ALTER TABLE business_processes ADD COLUMN import_batch_id INTEGER REFERENCES ingest_batches(id)",
         "business_processes", "import_batch_id"),
        ("ALTER TABLE business_processes ADD COLUMN needs_review BOOLEAN DEFAULT 0",
         "business_processes", "needs_review"),
        ("ALTER TABLE business_processes ADD COLUMN import_confidence REAL",
         "business_processes", "import_confidence"),
        ("ALTER TABLE bcp_dependencies ADD COLUMN source VARCHAR(16)",
         "bcp_dependencies", "source"),
        ("ALTER TABLE bcp_dependencies ADD COLUMN import_batch_id INTEGER REFERENCES ingest_batches(id)",
         "bcp_dependencies", "import_batch_id"),
        ("ALTER TABLE bcp_supplier_links ADD COLUMN scenario_ids JSON",
         "bcp_supplier_links", "scenario_ids"),
        ("ALTER TABLE bcp_supplier_links ADD COLUMN source VARCHAR(16)",
