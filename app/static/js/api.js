...
const Api = {
  ...
  tprm: {
    ...
    heatmap: () => Api.get('/api/tprm/dashboard/heatmap'),
    portfolioByTier: () => Api.get('/api/tprm/dashboard/portfolio-by-tier'),
    recompute: (id) => Api.post('/api/tprm/vendors/' + id + '/recompute-inherent-risk', {}),
  ...
  regwatch: {
    ...
    getSettings: () => Api.get('/api/regwatch/settings'),
    updateSettings: (d) => Api.put('/api/regwatch/settings', d),
    enable: () => Api.post('/api/regwatch/enable', {}),
    disable: () => Api.post('/api/regwatch/disable', {}),
    watchedFrameworks: () => Api.get('/api/regwatch/watched-frameworks'),
    inbox: (includeResolved) => Api.get('/api/regwatch/inbox' + (includeResolved ? '?include_resolved=true' : '')),
    inboxItem: (id) => Api.get('/api/regwatch/inbox/' + id),
    review: (id, decision) => Api.post('/api/regwatch/inbox/' + id + '/review', { decision: decision || {} }),
    snooze: (id, days) => Api.post('/api/regwatch/inbox/' + id + '/snooze', { days: days || 7 }),
    dismiss: (id, reason) => Api.post('/api/regwatch/inbox/' + id + '/dismiss', { reason: reason || '' }),
  ...
  vendor_issues: {
    ...
    get: (id) => Api.get('/api/vendor-issues/' + id),
    create: (d) => Api.post('/api/vendor-issues/', d),
